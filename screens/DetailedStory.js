...
let customFonts = {
  ...
  export default class DetailedStory extends React.Component{
    constructor(props) {
        super(props);
        this.state = {
          fontsLoaded: false,
      ...
      initiateSound=async(title,author,created_on,moral)=>{
        const currentColor=this.state.speakerColour;
        this.setState({
            speakerColour:currentColor==="gray"?"blue":"gray"
        })
        if(currentColor==="gray"){
            Speech.speak("The title is");
            Speech.speak(title);
            Speech.speak("The author of the story is:");
            Speech.speak(author);
                        ...
                        <View style={styles.dataContainer}>
                            ...
                            <View style={styles.iconContainer}>
                              <TouchableOpacity onPress={()=>{
                                  this.initiateSound(this.props.route.params.story.title,
                                  this.props.route.params.story.author,
                                  this.props.route.params.story.created_on,
                                  this.props.route.params.story.moral)
                              }}>
                                <Ionicons name={this.state.speakerIcon} color={this.state.speakerColour} style={{margin:RFValue(15)}} size={RFValue(30)}/>
                              </TouchableOpacity>
                            </View>
                        </View>
